...
- (id)initWithFrame:(CGRect)frame items:(NSArray *)items
{
    ...
    if (self)
    {
        ...
        self.table.layer.borderColor = [SIMenuConfiguration itemsColor].CGColor;
...
{
    [self.table selectRowAtIndexPath:[NSIndexPath indexPathForRow:index inSection:0] animated:NO scrollPosition:UITableViewScrollPositionNone];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.menuDelegate didSelectItemAtIndex:indexPath.row withTitle:self.items[indexPath.row]];
